...
const char* password = "craving for mor e";
String data ="";
...
//left
int MC1_M2_IN2 = 5; // GPIO5(D1)
int MC1_M2_IN1 = 1; // GPIO1(tx)
int ENB = 2; /* GPIO2(D4) -> SPEED Enable */
//back
//
int MC2_M1_IN2 = 14; // GPIO14(D5)
int MC2_M1_IN1 = 12; // GPIO12(D6)
//
int MC2_M2_IN2 = 13; // GPIO13(D7)
int MC2_M2_IN1 = 15; // GPIO15(D8)
int command[3];
